...
Y = pd.read_csv('../HDRA_CNN_Data/HDRA_Y.csv', index_col=0)
...
trait_loss = []
trait_corr = []
for itrait in range(8, 9):
    # load Processed Data
    chunk_filelist = natsorted(glob.glob("../HDRA_CNN_Data/HDRA_Raw_Chunk/" + "*.csv"))
    chunk_filelist = chunk_filelist[1:2]
    ...
    for chunk_filename in chunk_filelist:
        ...
        model_cnn = CNN(nSNP)
        # plot_model(model_cnn, to_file='../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/'
        #             'HDRA_CNN_Flowgraph_Raw/HDRA_CNN_Flowgraph_Raw_Chunk_{}'
        #            .format(index) + '.png',
        ...
        plt.savefig('../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/'
                    'HDRA_CNN_Loss_Raw/'
                    'HDRA_CNN_Loss_Raw_Trait_{}'.format(itrait) +
        ...
        pathlib.Path("../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/"
                     "HDRA_CNN_Prediction_Loss_Cor_Raw/"
                     "HDRA_CNN_Prediction_Loss_Raw_Trait_{}".format(itrait)
                     + '_chunk_{}'.format(index) + ".txt"). \
            write_text("HDRA_CNN_Prediction_Loss_Raw: {}"
                       .format(mse_prediction))
        ...
        plt.savefig('../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/'
                    'HDRA_CNN_Prediction_Plot_Raw/'
                    'HDRA_CNN_Prediction_Plot_Raw_Trait_{}'.format(itrait)
                    + '_chunk_{}'.format(index) + '.png')
        # plt.show()
        plt.clf()
        ...
        pathlib.Path("../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/"
                     "HDRA_CNN_Prediction_Loss_Cor_Raw/"
                     "HDRA_CNN_Prediction_Cor_Raw_Trait_{}".format(itrait)
                    + '_chunk_{}'.format(index) + ".txt"). \
            write_text("HDRA_CNN_Prediction_Cor_Raw: {}"
                       .format(corr))
...
# trait_loss_df.to_csv('../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/'
#                     'HDRA_CNN_Prediction_Result_Raw/'
#                      'HDRA_CNN_Prediction_loss_Raw.csv')
#
# trait_corr_df.to_csv('../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/'
#                     'HDRA_CNN_Prediction_Result_Raw/'
#                      'HDRA_CNN_Prediction_Result_Raw.csv')
#
# pathlib.Path("../HDRA_CNN_ModelMetaData/HDRA_CNN_Raw/HDRA_CNN_Prediction_Time_Raw/"
#              "HDRA_CNN_Prediction_Time_Raw.txt"). \
#     write_text("HDRA_CNN_Raw_Chunk_Training_Time: {}"
