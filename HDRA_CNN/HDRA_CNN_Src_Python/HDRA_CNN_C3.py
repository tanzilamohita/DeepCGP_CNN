...
X = pd.read_csv('../HDRA_CNN_Data/HDRA_X_C3.csv', index_col=0)#.iloc[0:, 1:]
...
for i in range(12, 13):
    ...
    plot_model(model_cnn, to_file='../HDRA_CNN_ModelMetaData/'
        'HDRA_CNN_C3/HDRA_CNN_Flowgraph_C3/HDRA_CNN_Flowgraph_C3.png',
    ...
    plt.savefig('../HDRA_CNN_ModelMetaData/'
        'HDRA_CNN_C3/HDRA_CNN_Loss_C3/'
                'HDRA_CNN_Loss_C3_Trait_{}'.format(i)
                + '.png')
    # plt.show()
    plt.clf()
    #
    ...
    plt.savefig('../HDRA_CNN_ModelMetaData/'
        'HDRA_CNN_C3/HDRA_CNN_Prediction_Plot_C3/'
                'HDRA_CNN_Prediction_Plot_C3_Trait_{}'.format(i) + '.png')
    # plt.show()
    plt.clf()
...
#         'HDRA_CNN_C3/HDRA_CNN_Prediction_Result_C3/'
#                 'HDRA_CNN_Prediction_Result_C3.csv',
#            np.column_stack(corr_df), delimiter=',', fmt='%1.3f', comments='')
#
# pathlib.Path("../HDRA_CNN_ModelMetaData/HDRA_CNN_C3/"
#              "HDRA_CNN_Prediction_Time_C3/"
#         "HDRA_CNN_Prediction_Time_C3.txt").\
#     write_text("HDRA_CNN_Prediction_Time_C3: {}"
