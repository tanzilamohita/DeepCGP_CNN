...
X = pd.read_csv('../C7AIR_CNN_Data/C7AIR_X_C2.csv', header=None)
...
plot_model(model_cnn, to_file='../C7AIR_CNN_ModelMetaData/'
            'C7AIR_CNN_Flowgraph/C7AIR_CNN_Flowgraph_C2.png',
...
plt.savefig('../C7AIR_CNN_ModelMetaData/C7AIR_CNN_Prediction_Plot/'
            'C7AIR_CNN_Prediction_C2.png')
plt.show()

pathlib.Path("../C7AIR_CNN_ModelMetaData/C7AIR_CNN_Prediction_Result/"
             "C7AIR_CNN_Prediction_Result_C2.txt")\
    .write_text("C7AIR_CNN_Prediction_Result_C2: {}"
                        .format(corr))

pathlib.Path("../C7AIR_CNN_ModelMetaData/C7AIR_CNN_Prediction_Time/"
             "C7AIR_CNN_Prediction_Time_C2.txt")\
    .write_text("C7AIR_CNN_Prediction_Time_C2: {}"
